...
export const sync_claim: (a: number, b: number, c: number, d: number, e: number) => any;
...
export const fetch_deposit_history: (a: number, b: number, c: number) => any;
export const fetch_transfer_history: (a: number, b: number, c: number) => any;
export const fetch_tx_history: (a: number, b: number, c: number) => any;
...
export const fetch_encrypted_data: (a: number, b: number, c: number, d: bigint, e: number, f: number, g: number, h: number, i: number) => any;
...
export const _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h14f4dbbe7ce8d72f: (a: number, b: number) => void;
export const closure689_externref_shim: (a: number, b: number, c: any) => void;
export const closure1397_externref_shim: (a: number, b: number, c: any, d: any) => void;
