...
export const __wbg_set_jsmetadata_uuid: (a: number, b: number, c: number) => void;
...
export const __wbg_get_jsmetadata_uuid: (a: number) => [number, number];
...
export const config_new: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: bigint, j: bigint, k: bigint, l: bigint, m: bigint, n: bigint, o: bigint, p: number, q: number, r: bigint, s: number, t: number, u: number, v: number, w: bigint, x: number, y: number, z: bigint, a1: number, b1: number, c1: number) => number;
...
export const __wbg_get_jsencrypteddata_uuid: (a: number) => [number, number];
export const __wbg_set_jsencrypteddata_uuid: (a: number, b: number, c: number) => void;
...
export const generate_auth_for_store_vault: (a: number, b: number) => any;
...
export const closure866_externref_shim: (a: number, b: number, c: any) => void;
export const closure1685_externref_shim: (a: number, b: number, c: any, d: any) => void;
